...
// source: mxprotocol-server/lpwan-app-server/staking.proto
...
func (*StakeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_13a4011948c6d1db, []int{0}
}
...
func (*StakeResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_13a4011948c6d1db, []int{1}
}
...
func (*UnstakeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_13a4011948c6d1db, []int{2}
}
...
func (*UnstakeResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_13a4011948c6d1db, []int{3}
}
...
func (*GetActiveStakesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_13a4011948c6d1db, []int{4}
}
...
func (*ActiveStake) Descriptor() ([]byte, []int) {
	return fileDescriptor_13a4011948c6d1db, []int{5}
}
...
func (*GetActiveStakesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_13a4011948c6d1db, []int{6}
}
...
func (*StakingHistoryRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_13a4011948c6d1db, []int{7}
}
...
func (*GetStakingHistory) Descriptor() ([]byte, []int) {
	return fileDescriptor_13a4011948c6d1db, []int{8}
}
...
func (*StakingHistoryResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_13a4011948c6d1db, []int{9}
}
...
func (*StakingPercentageRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_13a4011948c6d1db, []int{10}
}
...
func (*StakingPercentageResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_13a4011948c6d1db, []int{11}
}
...
func init() {
	proto.RegisterType((*StakeRequest)(nil), "m2m.StakeRequest")
	proto.RegisterType((*StakeResponse)(nil), "m2m.StakeResponse")
	proto.RegisterType((*UnstakeRequest)(nil), "m2m.UnstakeRequest")
	proto.RegisterType((*UnstakeResponse)(nil), "m2m.UnstakeResponse")
	proto.RegisterType((*GetActiveStakesRequest)(nil), "m2m.GetActiveStakesRequest")
	proto.RegisterType((*ActiveStake)(nil), "m2m.ActiveStake")
	proto.RegisterType((*GetActiveStakesResponse)(nil), "m2m.GetActiveStakesResponse")
	proto.RegisterType((*StakingHistoryRequest)(nil), "m2m.StakingHistoryRequest")
	proto.RegisterType((*GetStakingHistory)(nil), "m2m.GetStakingHistory")
	proto.RegisterType((*StakingHistoryResponse)(nil), "m2m.StakingHistoryResponse")
	proto.RegisterType((*StakingPercentageRequest)(nil), "m2m.StakingPercentageRequest")
	proto.RegisterType((*StakingPercentageResponse)(nil), "m2m.StakingPercentageResponse")
}

func init() {
	proto.RegisterFile("mxprotocol-server/lpwan-app-server/staking.proto", fileDescriptor_13a4011948c6d1db)
}

var fileDescriptor_13a4011948c6d1db = []byte{
	// 637 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *stakingServiceClient) Stake(ctx context.Context, in *StakeRequest, opts ...grpc.CallOption) (*StakeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/m2m.StakingService/Stake", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stakingServiceClient) Unstake(ctx context.Context, in *UnstakeRequest, opts ...grpc.CallOption) (*UnstakeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/m2m.StakingService/Unstake", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stakingServiceClient) GetActiveStakes(ctx context.Context, in *GetActiveStakesRequest, opts ...grpc.CallOption) (*GetActiveStakesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/m2m.StakingService/GetActiveStakes", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stakingServiceClient) GetStakingHistory(ctx context.Context, in *StakingHistoryRequest, opts ...grpc.CallOption) (*StakingHistoryResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/m2m.StakingService/GetStakingHistory", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stakingServiceClient) GetStakingPercentage(ctx context.Context, in *StakingPercentageRequest, opts ...grpc.CallOption) (*StakingPercentageResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/m2m.StakingService/GetStakingPercentage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _StakingService_Stake_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/m2m.StakingService/Stake",
	}
...
func _StakingService_Unstake_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/m2m.StakingService/Unstake",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _StakingService_GetActiveStakes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/m2m.StakingService/GetActiveStakes",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _StakingService_GetStakingHistory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/m2m.StakingService/GetStakingHistory",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _StakingService_GetStakingPercentage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/m2m.StakingService/GetStakingPercentage",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _StakingService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "m2m.StakingService",
	...
	Metadata: "mxprotocol-server/lpwan-app-server/staking.proto",
}
